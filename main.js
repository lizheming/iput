...
/***/ function(module, exports, __webpack_require__) {
	...
	var IPut = (function (_React$Component) {
	  ...
	  function IPut() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(IPut).call(this));
	  ...
	  _createClass(IPut, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: className },
	        this.state.value.map(function (val, i) {
	          return _react2.default.createElement(
	            'div',
